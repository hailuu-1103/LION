        ...
        <form class="form-horizontal mx-auto col-10 col-md-9 col-lg-8 m-3" action="addstock" method="POST">
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label" for="id">KIT ID</label>  
                    <div class="col-md-4">
                ...
                <div class="form-group" style="display: none">
                    <div class="col-md-4">
                        <input type="text" id="img" name="img" value="${requestScope.img}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-4">
                        <img src="${requestScope.img}" style="width: 120px; height: 150px;">
                    </div>
                </div>
