                ...
                <div class="row">
                    ...
                    <form class="col-lg-4 m-2" action="account" onsubmit="return check()" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" value="${requestScope.customer.username}" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Email:</label>
                            <input type="email" class="form-control" name="email" value="${requestScope.customer.email}">
                        </div>
                        <div class="form-group">
                            <label>Địa chỉ</label>
                    ...
                    <div class="col-lg-3 border border-dark m-5">
                        ...
                        <c:if test="${requestScope.orderNum>0}">
                            ...
                            <p><bold>${requestScope.most_buy.kitName}</bold> - <span style="color: red; font-size:20px; font-weight: bold">${requestScope.most_num}</span> sản phẩm </p>
