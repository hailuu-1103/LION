                            ...
                            <tbody>
                                <c:forEach items="${requestScope.data}" var="p">
                                    <tr>
                                        ...
                                        <td>${p.supplier}</td>
                                        <td>
                                            <a href="#editEmployeeModal" class="edit" data-toggle="modal" data-id="${p.kitID}" data-name="${p.kitName}" data-season="${p.season}" data-league="${p.league}" data-price="${p.price}" data-descript="${p.descript}" data-supplier="${p.supplier}" data-img="${p.img}"><i class="fas fa-pen"></i></a>
                                            <a href="#deleteEmployeeModal" class="delete" data-toggle="modal" data-id="${p.kitID}"><i class="fas fa-trash-alt"></i></a>
                                            <a href="addstock?id=${p.kitID}&img=${p.img}" style="margin: 5px">Add in Stock</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
